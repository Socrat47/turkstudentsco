  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="grid grid-cols-4 h-[700px] w-[1200px] rounded-xl overflow-hidden shadow-top-only">
        <div className="bg-myprimary col-span-1">
          <div className="absolute mt-36 mr-12">
            <Image src={"/ai.png"} alt="ai" width={400} height={400} />
          </div>
        </div>
              ...
              <div>
                <form className="flex flex-col gap-5 mt-5">
                  <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="E-Posta" className="w-[500px] h-10 rounded-md px-2 outline-none border border-gray-400 text-[16px] ml-1" />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold opacity-80">Şifre</label>
                    <input type="text" placeholder="Şifre" className="w-[500px] h-10 rounded-md px-2 outline-none border border-gray-400 text-[16px] ml-1" />
                  </div>
                </form>
